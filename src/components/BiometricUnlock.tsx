...
import { Button, YStack, Text, XStack, useTheme, Spinner } from 'tamagui';
import { Fingerprint, Lock, Unlock, ShieldCheck, ShieldAlert } from '@tamagui/lucide-icons';
...
export function BiometricUnlock() {
  ...
  return (
    <YStack
      ...
      borderWidth={1}
      borderColor={
        authStatus === 'success' ? '$green10' : authStatus === 'failed' ? '$red10' : '$borderColor'
      }
    >
