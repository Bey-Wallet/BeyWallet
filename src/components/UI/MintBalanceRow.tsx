...
export function MintBalanceRow({
  ...
  return (
    <XStack justify="space-between" items="center" width="100%" bg="$gray3" p="$4" rounded="$6">
      <XStack
        gap="$2"
        items="center"
      ...
      >
        {isLoadingMint ? (
          ...
          <Avatar rounded="$3" size="$2">
            ...
            <Avatar.Fallback backgroundColor="$gray3" alignItems="center" justifyContent="center">
