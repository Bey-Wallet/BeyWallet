...
} from '~/services/api/mintRecommendationService';
import { useWalletStore } from '~/state/walletStore';
import { initService } from '~/services/wallet';
import AddMintModal, { AddMintModalRef } from '~/shared/ui/AddMintModal';

import { MintList } from '~/features/explore/components/MintList';
import { MintEmptyState } from '~/features/explore/components/MintEmptyState';
import { type MintStatus } from '~/features/explore/components/MintListItem';
import ContactsView from '~/features/home/components/ContactsView';
    ...
    <SafeAreaView style={{ flex: 1 }}>
      <YStack flex={1} bg="$background">
        ...
        <XStack px="$4" py="$3">
          ...
          >
            <Search size={20} fontWeight="700" color="$gray10" />
            <Text color="$gray10" pr="$3" flex={1} text="center">
              Search mints & people
            </Text>
          </XStack>
        </XStack>
