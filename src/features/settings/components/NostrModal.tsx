...
export const NostrModal = React.forwardRef<AppBottomSheetRef>((props, ref) => {
  ...
  const [relays, setRelays] = useState<string[]>(['wss://relay.damus.io', 'wss://nos.lol']);
    ...
    <AppBottomSheet ref={ref} snapPoints={['80%']} onClose={() => setIsNsecVisible(false)}>
      <BottomSheetScrollView showsVerticalScrollIndicator={false}>
        <YStack p="$4" gap="$6" pb="$10">
          ...
          {/* Keys Section */}
          <YStack gap="$4">
            <Text fontSize="$4" fontWeight="700" color="$gray10">
              Your Identity
            </Text>
            ...
            <YStack gap="$2">
              ...
              <View bg="$red2" p="$3" rounded="$4" borderWidth={1} borderColor="$red5">
                <XStack items="center" justify="space-between" gap="$3">
                  ...
                  <XStack gap="$2">
                    ...
                    <Button
                      ...
                      icon={
                        isNsecVisible ? (
                          <EyeOff size={18} color="$red10" />
                        ) : (
                          <Eye size={18} color="$red10" />
                        )
                      }
          ...
          <YStack gap="$4">
            ...
            <Text fontSize="$3" color="$gray11">
              Relays are used to connect to the Nostr network.
            </Text>
