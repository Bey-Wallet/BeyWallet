    ...
    <AppBottomSheet ref={innerRef} snapPoints={['85%']}>
      <YStack p="$4" gap="$4">
          ...
          <XStack gap="$3">
            ...
            <YStack flex={1}>
              ...
              <Text color="$red10" fontSize="$3" mt="$1">
                This will permanently delete all wallet data including proofs, mints, and history.
                Back up your seed phrase before proceeding!
              </Text>
            </YStack>
          </XStack>
        </View>
        ...
        <YStack gap="$3">
          ...
          <View bg="$gray3" p="$3" rounded="$4" borderWidth={1} borderColor="$borderColor">
        ...
        <YStack gap="$3" mt="$2">
          {isDeleting ? (
            ...
            <>
              ...
              <Button size="$5" theme="gray" fontWeight="700" rounded="$4" onPress={onCancel}>
                Cancel
              </Button>
            </>
          )}
