    ...
    <YStack flex={1} bg="$background">
      ...
      >
        <YStack gap="$4">
          ...
          >
            <DetailItem label="Status" value="Success" valueColor="$green10" />
            <DetailItem label="Amount" value={currencyService.formatSats(Number(amount))} />
            <DetailItem label="Source Mint" value={getMintName(sourceMintUrl)} />
            <DetailItem label="Target Mint" value={getMintName(targetMintUrl)} />
          </YStack>
        </YStack>
      </ScrollView>
