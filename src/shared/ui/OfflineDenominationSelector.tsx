  ...
  if (availableProofs.length === 0) {
    return (
      ...
      >
        ...
        <Text color="$red10" fontWeight="700" textAlign="center">
          No offline funds available
        </Text>
        <Text color="$gray10" fontSize="$2" textAlign="center">
          You do not have any unspent proofs for this mint to send offline.
        </Text>
      </YStack>
    );
  }
            ...
            >
              <YStack gap="$1">
                <Text
                  fontSize="$4"
                  fontWeight="800"
                  color={selectedCount > 0 ? '$accent10' : '$color'}
                >
