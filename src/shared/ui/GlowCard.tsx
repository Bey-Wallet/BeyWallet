      ...
      >
        <Defs>
          <RadialGradient id="grad" cx="50%" cy="50%" r="80%">
            {/* center */}
            <Stop offset="0%" stopColor={resolvedGradientColor} stopOpacity="0.02" />

            {/* middle */}
            <Stop offset="50%" stopColor={resolvedMiddleColor} stopOpacity="0.5" />

            {/* edges */}
            <Stop offset="100%" stopColor={resolvedGradientColor} stopOpacity="0.7" />
          </RadialGradient>
        </Defs>
