...
export function MeltResultStage({
  status,
  amount,
  feeReserve,
  error,
  onClose,
}: MeltResultStageProps) {
      ...
      >
        <YStack gap="$4">
          ...
          <YStack gap="$3" py="$6" items="center" justify="center">
            <Text fontSize={52} fontWeight="700" color="$red10" lineHeight={54}>
          ...
          >
            <DetailItem label="Total Amount" value={currencyService.formatSats(amount)} />
