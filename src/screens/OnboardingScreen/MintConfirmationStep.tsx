  ...
  return (
    ...
    >
          ...
          {DEFAULT_MINTS.map((mint) => (
            ...
            >
              <XStack gap="$3" items="center">
                <View bg={mint.isTestnet ? '$orange3' : '$blue2'} p="$2" rounded="$3">
                  ...
                  <XStack items="center" gap="$2">
                    ...
                    {mint.isTestnet ? (
                      <View
                        ...
                        borderColor="$orange6"
                      >
                        <Text fontSize="$1" fontWeight="800" color="$orange10">
                          TESTNET
                        </Text>
                      </View>
                    ) : (
      ...
      <YStack gap="$3">
        ...
        <Button size="$4" chromeless onPress={handleSkip} disabled={isConnecting}>
