    ...
    <YStack gap="$4" py="$4">
      <YStack gap="$3" bg="$gray2" p="$4" rounded="$5">
        <XStack gap="$4" items="center">
          ...
          >
            {previewInfo?.icon ? (
              <Image source={{ uri: previewInfo.icon }} width={48} height={48} resizeMode="cover" />
            ) : (
        ...
        {previewInfo?.description && (
          <Text color="$gray10" fontSize="$3" mt="$1">
            {previewInfo.description}
          </Text>
        )}
        ...
        {isExistingUntrusted && (
          <XStack p="$3" bg="$orange2" rounded="$3" gap="$2" items="center" mt="$2">
            ...
            <Text fontSize="$3" color="$orange10" fontWeight="600">
              This mint is currently untrusted.
            </Text>
          </XStack>
        )}
      </YStack>
      ...
      <YStack mt="$4" gap="$3" flex={1}>
        ...
        <YStack p="$4" bg="$gray2" rounded="$4" mb="$2">
          ...
          <Text color="$gray10" fontSize="$3">
            By trusting this mint, you allow it to hold your ecash balances. Only trust mints
            operated by entities you know.
          </Text>
        </YStack>

        <Button size="$5" themeInverse onPress={handleTrustMint} icon={<Check size={20} />}>
