    ...
    for (let i = 0; i < 5; i++) {
      try {
        ...
        const [
          ...
          storedPrimary,
          storedSeedBackedUp,
          storedBackupDismissedAt,
          storedShowBitcoinSymbol,
          storedBackupDirectoryUri,
          storedUsernameClaimDismissedAt,
        ] = await Promise.all([
        ...
        if (
          storedUsernameClaimDismissedAt !== undefined &&
          storedUsernameClaimDismissedAt !== null
        ) {
